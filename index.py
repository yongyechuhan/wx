...
def app(environ, start_response):
    ...
    <html>
        ...
        <body>
            ...
            <br>
            <ul>以下链接可能对您有用：</ul>
            <ul><a href="https://bce.baidu.com/doc/BAE-Pro/QuickGuide.html" target="_blank">入门指南</a></ul>
            ...
            <ul><a href="https://bce.baidu.com/doc/BAE-Pro/FAQ.html" target="_blank">常见问题</a></ul>
        </body>
    </html>
    """
    body=[body_str]
